...
function AuthProvider({ children }) {
  ...
  const [user2, setUser] = (0, import_react.useState)(null);
  ...
  const value = (0, import_react.useMemo)(
    ...
    [status, user2, sessionExpired, login2, logout2, beginRegistration, completeRegistration, refresh]
  );
...
function MobileNav() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("nav", { "aria-label": "Mobile", className: "mobile-nav", children: items2.map((item) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
...
function Header() {
  ...
  const { status, user: user2, logout: logout2 } = useAuth();
  ...
  const authed = status === "authenticated" && !!user2;
        ...
        authed ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "user-menu", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "user-menu__avatar", "aria-hidden": "true", children: user2.username.charAt(0).toUpperCase() }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "user-menu__name", children: user2.username })
              ]
            }
          ),
          menuOpen && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "user-menu__dropdown", role: "menu", children: [
            ...
            user2.role === "superadmin" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              import_react_router_dom4.Link,
              {
                to: "/Admin/admin",
                className: "user-menu__item",
...
function AdminRoute() {
  const { status, user: user2, sessionExpired } = useAuth();
  if (status === "loading") {
  ...
  const isSuperAdmin = user2?.role === "superadmin";
  if (!isSuperAdmin) {
...
function MediaRow({ items: items2, className, empty }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: cn("media-row", className), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { ref: scrollerRef, className: "media-row__scroller", tabIndex: 0, children: items2.map((item) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(MediaCard, { item, className: "media-row__card" }, item.id)) }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
      "button",
      {
        type: "button",
...
function Home() {
  ...
  const hero2 = data?.hero ?? null;
  const sections = data?.sections ?? [];
  const totalItems = sections.reduce((n, s) => n + s.items.length, 0);
  if (!hero2 && totalItems === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(PageContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "home-status", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
      EmptyState,
      {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [
    hero2 ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(Hero, { item: hero2 }) : /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "hero hero--welcome", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "container hero__inner", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "hero__content", children: [
...
function MediaGrid({ items: items2, className, empty }) {
  if (items2.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className, children: empty ?? null });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: cn("media-grid", className), children: items2.map((item) => /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(MediaCard, { item }, item.id)) });
}
...
function Breadcrumbs({ items: items2 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("nav", { "aria-label": "Breadcrumb", className: "breadcrumb", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("ol", { className: "breadcrumb__list", children: items2.map((crumb, i) => {
...
function Tokens() {
  ...
  const lotusHubId = summary.data?.lotusHubId ?? user2.lotusHubId;
...
function Profile() {
  const { user: user2, logout: logout2 } = useAuth();
  const summary = useAccountSummary();
  ...
  const roleLabel = user2.role === "superadmin" ? "Super Admin" : user2.role === "admin" ? "Admin" : "Member";
  const lotusHubId = summary.data?.lotusHubId ?? user2.lotusHubId;
  const handleLogout = async () => {
    await logout2();
    navigate("/login", { replace: true });
    ...
    /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "acct-grid", children: [
      /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("section", { className: "acct-card", "aria-labelledby": "acct-identity", children: [
        /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "profile-identity", children: [
          /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("span", { className: "profile-identity__avatar", "aria-hidden": "true", children: user2.username.charAt(0).toUpperCase() }),
          /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("h2", { id: "acct-identity", className: "profile-identity__name", children: user2.username }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("dl", { className: "profile-details", children: [
          /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("dd", { children: user2.username })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("dd", { children: formatDate(user2.createdAt) })
          ] })
        ] })
      ] }),
...
Object.defineProperty(globalThis, "navigator", { value: window2.navigator, configurable: true });
...
var extra = {
  id: "currents",
  title: "Currents",
  description: "An ambient release.",
  type: "audio",
  category: "Music",
  thumbnailUrl: null,
  tags: ["music"],
...
globalThis.fetch = async (input) => {
  ...
  if (path === "/api/home")
    return respond({
      ...
      sections: [
        ...
        { id: "latest", title: "Latest added", items }
      ]
    });
  ...
  if (path === "/api/account/summary")
    return respond({
      ...
      freeQuotaResetsAt: Date.now() + 864e5,
      quotaTimezone: "UTC",
      tokenBalance: 12,
      tokenBatches: 2,
      nextTokenExpiryAt: Date.now() + 3 * 864e5,
...
function check(failures, name, ok) {
  console.log((ok ? "  \u2714 " : "  \u2718 ") + name);
